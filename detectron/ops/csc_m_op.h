#ifndef CAFFE2_OPERATORS_CSC_M_OP_H_
#define CAFFE2_OPERATORS_CSC_M_OP_H_
...
class CSCMOp final : public Operator<Context> {
 public:
  USE_OPERATOR_CONTEXT_FUNCTIONS;
  CSCMOp(const OperatorDef& operator_def, Workspace* ws)
...
#endif  // CAFFE2_OPERATORS_CSC_M_OP_H_
